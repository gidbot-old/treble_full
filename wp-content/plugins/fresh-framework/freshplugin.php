...
ffFrameworkVersionManager::getInstance()->addVersion('1.8.26', dirname(__FILE__).'/framework/bootstrap.php', dirname(__FILE__), plugin_dir_url(dirname(__FILE__).'/freshplugin.php') );
